...
public class TransparentRainbowStroke implements Shape{
	...
	public TransparentRainbowStroke(int x, int y, int width, int height,PApplet applet){
		this.x = x;
		this.y = y;
		this.width = width;
		this.height = height;
	...
	public void display() {
		...
		for(int j = 0; j < colours.length; j++){
			...
			applet.stroke(currentColour.r, currentColour.g, currentColour.b,20);
			applet.strokeWeight(this.stroke);
			applet.line(x,y+j*stroke/2,width,height+j*stroke/2);
		}
	}
	...
	public void setStroke(int stroke) {
		this.stroke = stroke/colours.length;
	}
